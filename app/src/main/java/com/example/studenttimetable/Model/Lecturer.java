...
public class Lecturer {
    ...
    public Lecturer(int id, String lecturerID, String fName, String lName, String address, String email, String password, String contactNumber, String emergencyNum,int isActive, String created, String createdBy, String modified, String modifiedBy) {
        this.id = id;
